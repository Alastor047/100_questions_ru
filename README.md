...
49. Как создается объект в Python, для чего __new__, зачем __init__? -------- повтор
...
54. Какие есть базовые [методы работы](https://proglib.io/p/kak-podruzhit-python-i-bazy-dannyh-sql-podrobnoe-rukovodstvo-2020-02-27) с SQL базой данных в Python?
